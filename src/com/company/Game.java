...
public class Game {
    ...
    public boolean whiteMove() {
        ...
        if (m_board.move(Integer.parseInt(inputs[1]), Integer.parseInt(inputs[0]), Integer.parseInt(inputs[3]), Integer.parseInt(inputs[2]), m_p1) == false) {
    ...
    public boolean blackMove() {
        ...
        String input = m_scanner.nextLine();
        String[] inputs = input.split(",");
        if (m_board.move(Integer.parseInt(inputs[1]), Integer.parseInt(inputs[0]), Integer.parseInt(inputs[3]), Integer.parseInt(inputs[2]), m_p2) == false) {
            System.out.println("That's not a move try again");
            return false;
        }
        m_board.printBoard();
